...
class Program
{
    ...
    {
        //HRASDataPopulation\DataImportFiles\Users.txt
        ...
        //C:\Users\Hayk Arzumanyan\source\repos\HRASDataPopulation\DataImportFiles
        filePath = "source\\repos\\HRASDataPopulation\\DataImportFiles\\Users.txt";
        filePath = "..\\DataImportFiles\\Users.txt";
        filePath = System.Reflection.Assembly.GetExecutingAssembly().Location + "\\..\\" + "Users.txt";

        filePath = @"C:\Users\Hayk Arzumanyan\source\repos\HRASDataPopulation\DataImportFiles\Users.txt";
        string directoryPath = @"C:\Users\Hayk Arzumanyan\source\repos\HRASDataPopulation\";
        string relativePath = Path.GetRelativePath(directoryPath, filePath);
        string currentDirectory = Directory.GetCurrentDirectory();
        filePath = Path.GetFullPath("Users.txt");
        relativePath = Path.Combine(currentDirectory, filePath);
        //Environment.CurrentDirectory = "source\\repos\\";
        currentDirectory = Directory.GetCurrentDirectory();

        string pathToIcoFile = AppDomain.CurrentDomain.BaseDirectory;
        pathToIcoFile = "..\\..\\" + pathToIcoFile;
        string sFilePath = Path.GetFullPath("\\HRASDataPopulation\\DataImportFiles\\Users.txt");

        string[] lines = File.ReadAllLines("..\\..\\DataImportFiles\\Users.txt");
        int rowsAffected = 0;
